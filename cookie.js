...
const translations = {
    'en': {
        ...
        marketingCookiesDesc: 'These cookies are used to deliver personalized advertisements.',
        cookieName: 'Cookie Name',
        cookiePurpose: 'Purpose',
        cookieType: 'Type',
        cookieDuration: 'Duration',
        languageLabel: 'Language:',
        floatingButton: 'Cookie Preferences',
        seeAnalytics: 'See Consent Analytics',
        dashboardTitle: 'Consent Analytics Dashboard',
        totalConsents: 'Total Consents',
        consentBreakdown: 'Consent Breakdown',
        necessary: 'Necessary',
        analytics: 'Analytics',
        marketing: 'Marketing',
        consentTrends: 'Consent Trends (Last 30 Days)',
        // Add translations for the password prompt
        passwordPrompt: 'Enter password to view analytics',
        submitButton: 'SUBMIT'
    },
    'it': {
        bannerMessage: 'Utilizziamo i cookie per garantire la migliore esperienza sul nostro sito web.',
        acceptAll: 'Accetta tutto',
        rejectAll: 'Rifiuta tutto',
        saveSettings: 'Salva impostazioni',
        cookieSettings: 'Impostazioni cookie',
        necessaryCookies: 'Cookie necessari',
        necessaryCookiesDesc: 'Questi cookie sono essenziali per il corretto funzionamento del sito web.',
        analyticsCookies: 'Cookie analitici',
        analyticsCookiesDesc: 'Questi cookie ci aiutano a capire come i visitatori interagiscono con il nostro sito.',
        marketingCookies: 'Cookie di marketing',
        marketingCookiesDesc: 'Questi cookie vengono utilizzati per fornire annunci pubblicitari personalizzati.',
        cookieName: 'Nome del cookie',
        cookiePurpose: 'Scopo',
        cookieType: 'Tipo',
        cookieDuration: 'Durata',
        languageLabel: 'Lingua:',
        floatingButton: 'Preferenze cookie',
        seeAnalytics: 'Vedi analisi del consenso',
        dashboardTitle: 'Dashboard analisi consenso',
        totalConsents: 'Consensi totali',
        consentBreakdown: 'Ripartizione consensi',
        necessary: 'Necessari',
        analytics: 'Analitici',
        marketing: 'Marketing',
        consentTrends: 'Tendenze consenso (ultimi 30 giorni)',
        // Add translations for the password prompt
        passwordPrompt: 'Inserisci la password per visualizzare le analisi',
        submitButton: 'INVIA'
    },
    'fr': {
        bannerMessage: 'Nous utilisons des cookies pour garantir la meilleure expérience sur notre site web.',
        acceptAll: 'Tout accepter',
        rejectAll: 'Tout rejeter',
        saveSettings: 'Enregistrer les paramètres',
        cookieSettings: 'Paramètres des cookies',
        necessaryCookies: 'Cookies nécessaires',
        necessaryCookiesDesc: 'Ces cookies sont essentiels pour le bon fonctionnement du site web.',
        analyticsCookies: 'Cookies analytiques',
        analyticsCookiesDesc: 'Ces cookies nous aident à comprendre comment les visiteurs interagissent avec notre site.',
        marketingCookies: 'Cookies marketing',
        marketingCookiesDesc: 'Ces cookies sont utilisés pour fournir des publicités personnalisées.',
        cookieName: 'Nom du cookie',
        cookiePurpose: 'Objectif',
        cookieType: 'Type',
        cookieDuration: 'Durée',
        languageLabel: 'Langue :',
        floatingButton: 'Préférences de cookies',
        seeAnalytics: 'Voir les analyses de consentement',
        dashboardTitle: 'Tableau de bord des analyses de consentement',
        totalConsents: 'Consentements totaux',
        consentBreakdown: 'Répartition des consentements',
        necessary: 'Nécessaires',
        analytics: 'Analytiques',
        marketing: 'Marketing',
        consentTrends: 'Tendances de consentement (30 derniers jours)',
        // Add translations for the password prompt
        passwordPrompt: 'Entrez le mot de passe pour voir les analyses',
        submitButton: 'SOUMETTRE'
    },
    'sv': {
        bannerMessage: 'Vi använder cookies för att säkerställa den bästa upplevelsen på vår webbplats.',
        acceptAll: 'Acceptera alla',
        rejectAll: 'Avvisa alla',
        saveSettings: 'Spara inställningar',
        cookieSettings: 'Cookie-inställningar',
        necessaryCookies: 'Nödvändiga cookies',
        necessaryCookiesDesc: 'Dessa cookies är nödvändiga för att webbplatsen ska fungera korrekt.',
        analyticsCookies: 'Analytiska cookies',
        analyticsCookiesDesc: 'Dessa cookies hjälper oss att förstå hur besökare interagerar med vår webbplats.',
        marketingCookies: 'Marknadsföringscookies',
        marketingCookiesDesc: 'Dessa cookies används för att leverera anpassade annonser.',
        cookieName: 'Cookie-namn',
        cookiePurpose: 'Syfte',
        cookieType: 'Typ',
        cookieDuration: 'Varaktighet',
        languageLabel: 'Språk:',
        floatingButton: 'Cookie-preferenser',
        seeAnalytics: 'Se samtyckesanalys',
        dashboardTitle: 'Samtyckesanalysdashboard',
        totalConsents: 'Totalt samtycke',
        consentBreakdown: 'Samtyckesfördelning',
        necessary: 'Nödvändiga',
        analytics: 'Analytiska',
        marketing: 'Marknadsföring',
        consentTrends: 'Samtyckestrend (senaste 30 dagarna)',
        // Add translations for the password prompt
        passwordPrompt: 'Ange lösenord för att visa analyser',
        submitButton: 'SKICKA'
    }
};
