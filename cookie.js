...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (geoItem) {
    ...
    // Setup scroll acceptance if enabled
        ...
        window.addEventListener('scroll', function() {
            if (bannerShown && !getCookie('cookie_consent')) {
                ...
                scrollTimer = setTimeout(function() {
                    ...
                    if (scrollPercentage > 70) { // If scrolled 70% of page
                        acceptAllCookies();
                        hideCookieBanner();
                        if (config.behavior.showFloatingButton) {
                            showFloatingButton();
    ...
    // Setup continue browsing acceptance if enabled
...
window.cookieConsent = {
    ...
    setConfig: function(newConfig) { 
        ...
        if (newConfig.languageConfig || newConfig.behavior.rememberLanguage) {
